...
find_and_search_service = FindAndSearchService()

@swagger_auto_schema(method="get",manual_parameters=[
            Parameter('district_name', IN_QUERY,
                      '검색 지역 입니다. 쿼리스트링입니다.',
                      type='str'),
        ], )
@api_view(["GET"])
...
def live_data_get(request):
    ...
    res = find_and_search_service.request_water_level_and_day_avg_rainfall(district_name=district_name)
